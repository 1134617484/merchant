        ...
        if (data.length > 0) {
          ...
          for (let i = 0; i < data.length; i++) {
            tableList.push({
              ...
              appeal_merchant:data[i].appeal_type==1?data[i].appeal_merchant.username:data[i].appeal_order.pay_order_id?data[i].appeal_order.pay_order_id:data[i].appeal_order_id,
